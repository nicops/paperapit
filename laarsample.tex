...
\diagrama{dvcs_roundup_plot_commits.png}{Check-in Dependence on Repository Growth}
...
\diagrama{dvcs_roundup_plot_sizes.png}{Repository Size Growth}
...
\diagrama{dvcs_roundup_plot_steps1.png}{Dependance on Check-in Size}
