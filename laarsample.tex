...
% - push-pull-commit (local commit, distributed repositories)
% - Flexibility
% - Changesets & patches
% - Cherry-picking
% - Merging
...
% Reveer diferencia entre changes & patch. Ver bien la diferencia o juntarlos.
%Arq
...
%Arq
\subsection{Patchs}
% No usar you. Ver si se puede explicar mejor lo de atomic way
...
%
% Dar vuelta la redacción. Tree son changesets => 
%
...
% Intercalar tortoise con tortoise-git y el del svn con el svn
...
% Reveer de mover esta sección antes de la comparacion
...
% Reveer saw tooth a ver si se dice así de posta
