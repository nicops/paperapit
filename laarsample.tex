...
of it, even if most of the time you can ignore most features and use just what you need. However for one person proyects, 
Git and Mercurial might be easier to use than SVN.
